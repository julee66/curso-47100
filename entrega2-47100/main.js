...
prendasDeRopa.push(new Remera (9, "Remera", "Verde", 6500));
...
const filtrarPorPrenda = () => {
    ...
    while (filtrado == false) {
        alert(prompt("Ese comando no fue encontrado. Intentelo de nuevo."));
...
const filtrarPorPrecio = () => {
    ...
    while (filtrado.length == 0 ) {
        alert(Number(prompt("Ese comando no fue encontrado. Intentelo de nuevo.")));
